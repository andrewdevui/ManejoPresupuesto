...
namespace ManejoPresupuesto.Servicios
{
    ...
    {
        Task<IEnumerable<ResultadoObtenerSemana>> ObtenerReporteSemanal(int usuarioId, int mes, int año, dynamic ViewBag);
        Task<ReporteTransaccionesDetalladas> ObtenerReporteTransaccionesDetalladas(int usuarioId, int mes, int año, dynamic ViewBag);
        Task<ReporteTransaccionesDetalladas> ObtenerTransaccionesDetalladasPorCuenta(int usuarioId, int cuentaId, int mes, int año, dynamic Viewbag);
    }
    public class ServicioReportes : IServicioReportes
    {
        ...
        public async Task<IEnumerable<ResultadoObtenerSemana>> ObtenerReporteSemanal(int usuarioId, int mes, int año, dynamic ViewBag)
        {
            (DateTime fechaInicio, DateTime fechaFin) = GenerarFechaInicioYFin(mes, año);
            var parametro = new ParamteroObtenerTransaccionesUsuarios
            {
                UsuarioId = usuarioId,
        ...
        public async Task<ReporteTransaccionesDetalladas> ObtenerTransaccionesDetalladasPorCuenta(int usuarioId, int cuentaId, int mes, int año, dynamic ViewBag)
        {
            (DateTime fechaInicio, DateTime fechaFin) = GenerarFechaInicioYFin(mes, año);
